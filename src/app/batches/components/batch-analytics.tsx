          ...
          <CardContent className="p-6">
            ...
            <div
              className={`text-2xl font-bold ${
                costAnalysis.overallMargin >= 30
                  ? "text-green-600"
                  : costAnalysis.overallMargin >= 20
                  ? "text-yellow-600"
                  : "text-red-600"
              }`}
            >
              {costAnalysis.overallMargin.toFixed(1)}%
            </div>
          </CardContent>
        </Card>
      </div>
              ...
              <div className="flex items-start gap-3 p-3 bg-yellow-50 dark:bg-yellow-950/20 rounded-lg">
                ...
                <div>
                  ...
                  <div className="text-sm text-yellow-800 dark:text-yellow-200">
                    ...
                    {costAnalysis.overallMargin.toFixed(1)}%. Consider reviewing
