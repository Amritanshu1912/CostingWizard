...
export function LabelsPriceComparison() {
  const priceComparisons = useLabelPriceComparison();
    ...
    return (
      <Card className="card-enhanced">
        <CardHeader>
          ...
          <CardDescription>
            Compare label prices across suppliers
          </CardDescription>
        </CardHeader>
        <CardContent>
          <div className="text-center py-8">
            ...
            <p className="text-muted-foreground">
              No labels with multiple suppliers found for comparison
            </p>
          </div>
        </CardContent>
      </Card>
  ...
  return (
    <div className="space-y-6">
      {priceComparisons.map((comparison) => (
        <Card key={comparison.labelName} className="card-enhanced">
          <CardHeader>
            <CardTitle className="flex items-center gap-2">
              {comparison.labelName}
